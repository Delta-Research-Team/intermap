...
class PrevalencePlot:
    ...
    def process_data(self):
        ...
        """
        self.processed_data = process_prevalence_data(self.df,
    ...
    def create_bar_traces(self):
        ...
        for item in self.processed_data:
            x_value = item['sel1'] if self.plot_type == 'sel1' else item[
                'sel2']
            other_sel = item['sel2'] if self.plot_type == 'sel1' else item[
                'sel1']
